...
import gt.tools.preference.annotation.JsonPreference;

import javax.lang.model.element.Element;
import javax.lang.model.element.TypeElement;
import javax.lang.model.type.DeclaredType;

public class JsonVisitor extends GenVisitor<JsonPreference> {
    @Override
    protected void appendGetterSetter(StringBuilder getterSetter, StringBuilder imports, Element field, String key, JsonPreference annotation) {
    ...
    @Override
    protected String getAnnotationKey(JsonPreference annotation) {
        return annotation.key();
    }

    @Override
    public String getPrefName(JsonPreference annotation) {
